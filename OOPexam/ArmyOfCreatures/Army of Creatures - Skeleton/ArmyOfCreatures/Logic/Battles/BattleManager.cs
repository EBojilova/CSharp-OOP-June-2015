namespace ArmyOfCreatures.Logic.Battles
{
    ...
    public class BattleManager : IBattleManager
    {
        ...
        public void Attack(CreatureIdentifier attackerIdentifier, CreatureIdentifier defenderIdentifier)
        {
            ...
            this.logger.WriteLine(
                string.Format(CultureInfo.InvariantCulture, LogFormat, "Attacker before", attackerCreature));
            this.logger.WriteLine(
                string.Format(CultureInfo.InvariantCulture, LogFormat, "Defender before", defenderCreature));
            ...
            this.logger.WriteLine(
                string.Format(CultureInfo.InvariantCulture, LogFormat, "Attacker after", attackerCreature));
            this.logger.WriteLine(
                string.Format(CultureInfo.InvariantCulture, LogFormat, "Defender after", defenderCreature));
        }
        ...
        protected virtual ICreaturesInBattle GetByIdentifier(CreatureIdentifier identifier)
        {
            ...
            {
                return this.secondArmyCreatures.FirstOrDefault(
                    x => x.Creature.GetType().Name == identifier.CreatureType);
            }
