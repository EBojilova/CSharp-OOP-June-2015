...
{
    private long numerator;//chislitel
    private long denominator;//znamenatel

    public Fraction(long numerator, long denominator)
    {
        // Cancel the fraction and make the denominator(znamenatel) positive
    ...
    public static Fraction operator +(Fraction f1, Fraction f2)// overload na operatora +
    {
    ...
    //Vsichki metodi sa static, tai kato operatorite sa statichni
